...
Thanks to [Brian Egolf](https://github.com/egolfbr/CSE271_Notes)
...
a programmer to call the constructor in a parent class. Look at the following
example.
...
Example:
(this example will not render unless using enhanced markdown viewer in VS code)
...
This is a "safe" type cast because if a child reference is valid, then the parent reference has to valid.
...
Returns True if the specified class is present in the descendent.
...
Deep copies creates new objects and copies the values. This will create separate objects so a change in object 2 will not affect object 1. This increases memory usage.
